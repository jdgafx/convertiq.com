...
export const metadata: Metadata = {
  ...
  keywords: ["contact AMP Marketing", "marketing consultation", "free marketing trial", "Nashua NH marketing agency contact", "AI marketing demo", "lead generation consultation", "schedule marketing call"],
  openGraph: {
