...
export default function Home() {
  const services = [
    { icon: "🚀", title: "AI Lead Generation", href: "/services/lead-generation", desc: "We build AI systems that find your ideal customers across social media, search, and 100+ ad platforms. Our programmatic approach means your pipeline stays full while you focus on closing deals. It's like having a full-time prospecting team that never sleeps.", price: "$2,499/mo" },
    { icon: "💡", title: "AI Consulting", href: "/services/ai-consulting", desc: "Not sure where AI fits in your business? We'll audit your operations and build a roadmap. From automation opportunities to custom implementations, we help you cut costs and scale faster. Think of us as your AI strategy partner.", price: "$500/hr or $3,999/mo" },
    ...
    { icon: "⚙️", title: "Custom AI Applications", href: "/services/custom-apps", desc: "Need something built specifically for your workflow? We create bespoke AI applications that integrate with your existing tools. From internal automation to customer-facing features, we build software that gives you a competitive edge.", price: "Custom quote" },
