...
export const metadata: Metadata = {
  ...
  keywords: ["AI marketing agency", "automated lead generation", "AI chatbot for business", "AI voice receptionist", "marketing automation", "lead generation services", "sales automation tools", "small business marketing", "Nashua NH marketing agency", "digital marketing automation", "Bing Ads management", "Google Ads agency", "AI lead capture", "appointment booking automation", "business growth tools"],
  openGraph: {
