...
export default function Home() {
  const services = [
    { icon: "🧲", title: "Automated Lead Capture", href: "/services/lead-funnel", desc: "Your site should be working for you every hour of the day. Our system finds people on social media and your website, starts a conversation, and gets them on your calendar. You will wake up to a list of qualified appointments. It's really that simple.", price: "$1,499 one-time" },
