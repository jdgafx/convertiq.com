...
export default function Home() {
  const services = [
    { icon: "🧲", title: "AI Assisted Advanced LeadGen", href: "/services/lead-funnel", desc: "Your site should be working for you every hour of the day. Our system finds people on social media and your website, starts a conversation, and gets them on your calendar. You will wake up to a list of qualified appointments. It's really that simple.", price: "$1,499 one-time" },
    ...
    { icon: "📞", title: "Virtual Front Desk", href: "/services/ai-voice", desc: "Every missed call is a missed opportunity for your business growth. This system answers every call, filters out the spam, and makes sure real prospects get on your calendar immediately. No more worrying about the phone while you're busy with clients.", price: "$249/mo" },
    ...
    { icon: "📱", title: "Consistent Social Presence", href: "/services/social-media", desc: "Managing social media can feel like a second job for many owners. We handle the monthly posts across all platforms so you stay relevant and visible without ever having to touch your phone. Everyone wins. You stay visible, and we do the work.", price: "$299/mo" },
    { icon: "📝", title: "High-Performance Ads", href: "/services/ad-copy", desc: "Stop guessing with your advertising budget every month. We create headlines that grab attention and constantly test different versions until your cost per lead starts dropping. You watch the numbers improve while we handle the data. Results you can actually track.", price: "$199/mo" },
    { icon: "🔍", title: "Content That Ranks", href: "/services/seo-content", desc: "Articles that provide real value to your readers. We help you rank on Google by writing things people actually want to read, rather than just filling pages with keywords. High-quality content that drives real traffic. No keyword stuffing involved.", price: "$149/article" },
    { icon: "🎯", title: "Pages That Really Sell", href: "/services/landing-pages", desc: "Some pages just sit there doing nothing for your business. Ours are built to drive action—getting people to click, call, or buy. Every headline and button placement is tested to make sure you get the best return on your investment. Pages designed specifically for sales.", price: "$799/page" },
  ];
