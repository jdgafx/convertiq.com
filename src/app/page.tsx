...
export default function Home() {
  const services = [
    { icon: "🧲", title: "Automated Lead Capture", href: "/services/lead-funnel", desc: "Your site should be working for you 24/7. Our system finds people on social media and your website, starts a conversation, and gets them on your calendar. You just wake up to a list of qualified appointments. It's that simple.", price: "$1,499 one-time" },
    { icon: "🤖", title: "Smart Website Chat", href: "/services/ai-chatbot", desc: "A chatbot that actually makes sense. It handles visitor questions with a human touch and books meetings while you're focused on your work. One client recently saw their lead count triple in a single week. It's a game changer.", price: "$149/mo" },
    { icon: "📞", title: "Virtual Front Desk", href: "/services/ai-voice", desc: "Every missed call is a missed opportunity for your business. This system answers every call, filters out the spam, and makes sure real prospects get on your calendar immediately. No more worrying about the phone while you're busy.", price: "$249/mo" },
    { icon: "📍", title: "Local Search Mastery", href: "/services/google-business", desc: "If you aren't on page one of Maps, you're losing local customers. We refine your profile so people in your neighborhood actually see you when they search for what you do. More visibility means more phone calls. Simple math.", price: "$399 one-time" },
    { icon: "⭐", title: "Reputation Management", href: "/services/review-response", desc: "Replying to reviews is essential but takes way too much time. Our system handles it for you with thoughtful responses that keep your reputation high. Good reviews are celebrated, and concerns are handled professionally. All without you typing a word.", price: "$99/mo" },
    { icon: "✉️", title: "Natural Follow-Ups", href: "/services/email-automation", desc: "Emails that people actually want to read. We skip the corporate jargon and write natural follow-up sequences that turn interested visitors into long-term clients. It moves leads through your pipeline automatically. No more manual follow-ups.", price: "$49/mo + $199 setup" },
    { icon: "📱", title: "Consistent Social Presence", href: "/services/social-media", desc: "Managing social media can feel like a second job. We handle the monthly posts across all platforms so you stay relevant and visible without ever having to touch your phone. Everyone wins. You stay visible, we do the work.", price: "$299/mo" },
    { icon: "📝", title: "High-Performance Ads", href: "/services/ad-copy", desc: "Stop guessing with your ad budget. We create headlines that pull people in and keep testing different versions until your cost per lead starts dropping. You watch the numbers improve while we handle the data. Results you can actually track.", price: "$199/mo" },
    { icon: "🔍", title: "Content That Ranks", href: "/services/seo-content", desc: "Articles that provide real value to your audience. We help you rank on Google by writing things people actually want to read, rather than just filling pages with keywords. High-quality content that drives real traffic. No keyword stuffing.", price: "$149/article" },
    { icon: "🎯", title: "Pages That Really Sell", href: "/services/landing-pages", desc: "Some pages just sit there doing nothing. Ours are built to drive action—getting people to click, call, or buy. Every headline and button placement is tested to make sure you get the best return on your investment. Pages designed for sales.", price: "$799/page" },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Most marketing agencies make things way too complicated. We don't. We use smart technology to find you qualified leads and book appointments automatically so you can focus on running your business. It's simple, fast, and it works.
            </p>
