...
export default function Home() {
  const services = [
    ...
    { icon: "📞", title: "AI Voice", href: "/services/ai-voice", desc: "Our AI answers your phone, asks the right questions, and books appointments. Inbound or outbound calls—doesn't matter. Your phone turns into a money-making machine that never takes a break. Powered by VoiceIQ, which we trust completely.", price: "Starting at $497 Setup + $249/mo" },
