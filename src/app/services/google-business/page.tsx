        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">Just to be honest, the majority of Google Business profiles are only halfway finished. It is like handing over money to your competitors. By optimizing every square inch of your profile, we ensure that you get the most from the local search results.</p>
