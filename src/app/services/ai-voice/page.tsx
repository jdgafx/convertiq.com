    ...
    <main className="min-h-screen bg-white font-poppins">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">It has been proved that on average, most businesses only manage to answer two-thirds of their calls. So, by not answering the calls, they are leaving the same amount of money on the table, literally. Our system trains your staff to be always ready to engage with the caller including the booking process at all times, even at 2 AM on a Sunday.</p>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-3xl p-8">
              ...
              <p className="text-gray-600 mb-6">Great phone answering installation & 24/7 after care service</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Got questions? We're here to help!</h2>
          {[
