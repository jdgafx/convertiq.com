...
export const metadata = {
  ...
  keywords: ["AI voice receptionist", "automated phone answering", "AI phone system", "virtual receptionist for business", "24/7 call answering", "missed call solution", "AI appointment booking phone"],
};
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">Most businesses only answer about two-thirds of their calls. That means a third of potential revenue goes straight to a competitor. Our AI receptionist picks up every single call, engages the caller in natural conversation, and books appointments around the clock — even at 2 AM on a Sunday.</p>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-3xl p-8">
              ...
              <p className="text-gray-600 mb-6">Full setup, custom training, and 24/7 support included</p>
