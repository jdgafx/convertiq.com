...
export const metadata = {
  ...
  keywords: ["lead generation funnel", "AI lead generation", "automated sales funnel", "lead capture system", "lead nurturing automation", "B2B lead generation", "appointment booking funnel"],
};
