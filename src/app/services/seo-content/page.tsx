...
export const metadata = {
  ...
  keywords: ["SEO content writing", "SEO articles", "content marketing services", "blog writing service", "organic traffic growth", "keyword-optimized content", "SEO copywriting agency"],
};
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-600 mb-4">Some pages attract steady traffic for years. Others get zero visitors. The difference is strategy. We write for your audience first and search engines second—so your content performs on both fronts. Here's what goes into every article:</p>
